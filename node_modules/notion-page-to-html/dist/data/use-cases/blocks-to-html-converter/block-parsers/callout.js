        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2: return [2 /*return*/, _b.apply(_a, [_c + (_d.sent()) + "</p>\n</div>\n    "])];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this._icon.startsWith('http'))
                            return [2 /*return*/, "<div class=\"callout-emoji\">" + this._icon + "</div>"];
                        url = "https://www.notion.so/image/" + encodeURIComponent(this._icon) + "?table=block&id=" + this._id;
                        return [4 /*yield*/, base_64_converter_1.Base64Converter.convert(url)];
                    case 1:
                        imageSource = _a.sent();
                        caption = 'callout icon';
                        return [2 /*return*/, "<div class=\"callout-image\"><img src=\"" + imageSource + "\" alt=\"" + caption + "\"></div>"];
                }
            });
        });
    };
